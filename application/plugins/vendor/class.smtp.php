...
class SMTP
{
     ...
     * The PHPMailer SMTP Version number.
     * @type string
     * @deprecategoryIdd Use the constant instead
     * @see SMTP::VERSION
     */
     ...
     * @type int
     * @deprecategoryIdd This is only ever used as a default value, so use the constant instead
     ...
     * @access public
     * @return bool True if successfully authenticategoryIdd.
     */
    public function authenticategoryId(
        $username,
        $password,
        $authtype = 'LOGIN',
        $realm = '',
